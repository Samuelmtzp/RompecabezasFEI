...
namespace RompecabezasFei.ServicioRompecabezasFei {
    ...
    public interface IServicioJuego {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioJuego/ConectarCuentaJugadorASala", ReplyAction="http://tempuri.org/IServicioJuego/ConectarCuentaJugadorASalaResponse")]
        System.Threading.Tasks.Task ConectarCuentaJugadorASalaAsync(string nombreJugador, string idSala);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioJuego/DesconectarCuentaJugadorDeSala", ReplyAction="http://tempuri.org/IServicioJuego/DesconectarCuentaJugadorDeSalaResponse")]
        System.Threading.Tasks.Task DesconectarCuentaJugadorDeSalaAsync(string nombreJugador, string idSala);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServicioJuego/EnviarMensaje")]
        void EnviarMensaje(string nombreJugador, string idSala, string mensaje);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServicioJuego/EnviarMensaje")]
        System.Threading.Tasks.Task EnviarMensajeAsync(string nombreJugador, string idSala, string mensaje);
    ...
    public interface IServicioJuegoCallback {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServicioJuego/MensajeCallBack")]
    ...
    public partial class ServicioJuegoClient : System.ServiceModel.DuplexClientBase<RompecabezasFei.ServicioRompecabezasFei.IServicioJuego>, RompecabezasFei.ServicioRompecabezasFei.IServicioJuego {
        ...
        public void ConectarCuentaJugadorASala(string nombreJugador, string idSala) {
            base.Channel.ConectarCuentaJugadorASala(nombreJugador, idSala);
        }
        
        public System.Threading.Tasks.Task ConectarCuentaJugadorASalaAsync(string nombreJugador, string idSala) {
            return base.Channel.ConectarCuentaJugadorASalaAsync(nombreJugador, idSala);
        }
        
        public void DesconectarCuentaJugadorDeSala(string nombreJugador, string idSala) {
            base.Channel.DesconectarCuentaJugadorDeSala(nombreJugador, idSala);
        }
        
        public System.Threading.Tasks.Task DesconectarCuentaJugadorDeSalaAsync(string nombreJugador, string idSala) {
            return base.Channel.DesconectarCuentaJugadorDeSalaAsync(nombreJugador, idSala);
        }
        
        public void EnviarMensaje(string nombreJugador, string idSala, string mensaje) {
            base.Channel.EnviarMensaje(nombreJugador, idSala, mensaje);
        }
        
        public System.Threading.Tasks.Task EnviarMensajeAsync(string nombreJugador, string idSala, string mensaje) {
            return base.Channel.EnviarMensajeAsync(nombreJugador, idSala, mensaje);
        }
